...
import type { ManagerProfile, ComplianceItem, ScannedStudent, TenancyRecord, ChatMessage, TenantBillingState, PaymentRecord } from '@/shared/types/app-types'
  ...
  actions: {
    async loadDashboard() {
      ...
      try {
        ...
        // 1) Accommodations managed by this manager (accommodation_manager_id)
