...
const isInConversation = computed(() => route.path.startsWith('/student/messages') && Boolean(route.query.landlord))
const showFab = computed(() => !isSecondaryPage.value && !isInConversation.value)
