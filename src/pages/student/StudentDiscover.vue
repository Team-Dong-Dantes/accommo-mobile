...
function messageManager(managerId: string) {
  void router.push({ path: '/student/messages', query: { manager: managerId } });
}
...
function openRoomChat(room: DiscoverRoom) {
  void router.push({ path: '/student/messages', query: { manager: room.managerId, room: room.id } });
}
...
async function applyToRoom(room: DiscoverRoom) {
  ...
  try {
    ...
    void router.push({ path: '/student/messages', query: { manager: room.managerId } });
  } catch (cause) {
