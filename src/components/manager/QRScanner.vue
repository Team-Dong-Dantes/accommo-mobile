...
.camera-empty__icon { display: grid; width: 56px; height: 56px; margin-bottom: var(--m-space-3); place-items: center; border-radius: 50%; background: rgba(255,255,255,0.08); color: var(--m-primary); }
...
.focus-corner { position: absolute; width: 22px; height: 22px; border-color: var(--m-primary); border-style: solid; border-width: 0; }
...
/* ---------- Sheets ---------- */
.sheet-card { grid-column: 1 / -1; border: 0; border-radius: var(--m-radius-lg) var(--m-radius-lg) 0 0; box-shadow: 0 -8px 30px rgba(15,23,42,0.14); color: var(--m-text); background: var(--m-surface); }
...
.sheet-grip { width: 40px; height: 4px; margin: 0 auto; border-radius: 999px; background: var(--m-border); }
